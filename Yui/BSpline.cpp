...
void BSPline::InitializeControlPoints()
{
    ...
    */
    ...
    controlPointsArray[0][2].x = -0.5;  controlPointsArray[0][2].y = 0.0;  controlPointsArray[0][2].z = 2.0;
    ...
    controlPointsArray[1][0].x = 0.0;  controlPointsArray[1][0].y = 0.0;  controlPointsArray[1][0].z = 4.0;
    ...
    controlPointsArray[1][4].x = 0.0;  controlPointsArray[1][4].y = 0.0;  controlPointsArray[1][4].z = 0.0;
    //controlPointsArray[1][5].x = 0.0;  controlPointsArray[1][5].y = 1.8;  controlPointsArray[1][5].z = -1.0;
    
    
    controlPointsArray[2][0].x = 1.0;  controlPointsArray[2][0].y = -0.0;  controlPointsArray[2][0].z = 4.0;
    controlPointsArray[2][1].x = 1.0;  controlPointsArray[2][1].y = -0.0;  controlPointsArray[2][1].z = 3.0;
    controlPointsArray[2][2].x = 1.0;  controlPointsArray[2][2].y = 0.0;  controlPointsArray[2][2].z = 2.0;
    controlPointsArray[2][3].x = 1.0;  controlPointsArray[2][3].y = 0.0;  controlPointsArray[2][3].z = 1.0;
    controlPointsArray[2][4].x = 1.0;  controlPointsArray[2][4].y = 0.0;  controlPointsArray[2][4].z = 0.0;
   // controlPointsArray[2][5].x = 1.0;  controlPointsArray[2][5].y = 1.8;  controlPointsArray[2][5].z = -1.0;
    ...
    controlPointsArray[3][4].x = 2.0;  controlPointsArray[3][4].y = 0.0;  controlPointsArray[3][4].z = 0.0;
   // controlPointsArray[3][5].x = 2.0;  controlPointsArray[3][5].y = 1.8;  controlPointsArray[3][5].z = -1.0;
    ...
    controlPointsArray[4][2].x = 2.5;  controlPointsArray[4][2].y = 0.0;  controlPointsArray[4][2].z = 2.0;
