...
void BSPline::InitializeControlPoints()
{
    ...
    */
    ...
    controlPointsArray[0][0].x = -3;  controlPointsArray[0][0].y = 0.0;  controlPointsArray[0][0].z = 5.0;
    ...
    controlPointsArray[0][4].x = -3;  controlPointsArray[0][4].y = 0.0;  controlPointsArray[0][4].z = -2;
    ...
    controlPointsArray[1][2].x = 0.0;  controlPointsArray[1][2].y = 0.0;  controlPointsArray[1][2].z = 2.0;
    controlPointsArray[1][3].x = 0.0;  controlPointsArray[1][3].y = 0.0;  controlPointsArray[1][3].z = 1.0;
    controlPointsArray[1][4].x = 0.0;  controlPointsArray[1][4].y = 0.0;  controlPointsArray[1][4].z = -1;
    //controlPointsArray[1][5].x = 0.0;  controlPointsArray[1][5].y = 1.8;  controlPointsArray[1][5].z = -1.0;
    ...
    controlPointsArray[2][2].x = 1.0;  controlPointsArray[2][2].y = 0.0;  controlPointsArray[2][2].z = 2.0;
    controlPointsArray[2][3].x = 1.0;  controlPointsArray[2][3].y = 0.0;  controlPointsArray[2][3].z = 1.0;
    controlPointsArray[2][4].x = 1.0;  controlPointsArray[2][4].y = 0.0;  controlPointsArray[2][4].z = -1;
    // controlPointsArray[2][5].x = 1.0;  controlPointsArray[2][5].y = 1.8;  controlPointsArray[2][5].z = -1.0;
    
    
    controlPointsArray[3][0].x = 2.0;  controlPointsArray[3][0].y = -0.0;  controlPointsArray[3][0].z = 4.0;
    controlPointsArray[3][1].x = 2.0;  controlPointsArray[3][1].y = -0.0;  controlPointsArray[3][1].z = 3.0;
    controlPointsArray[3][2].x = 2.0;  controlPointsArray[3][2].y = 0.0;  controlPointsArray[3][2].z = 2.0;
    controlPointsArray[3][3].x = 2.0;  controlPointsArray[3][3].y = 0.0;  controlPointsArray[3][3].z = 1.0;
    controlPointsArray[3][4].x = 2.0;  controlPointsArray[3][4].y = 0.0;  controlPointsArray[3][4].z = -1;
    // controlPointsArray[3][5].x = 2.0;  controlPointsArray[3][5].y = 1.8;  controlPointsArray[3][5].z = -1.0;
    
    
    controlPointsArray[4][0].x = 5.0;  controlPointsArray[4][0].y = -0.0;  controlPointsArray[4][0].z = 4.0;
    ...
    controlPointsArray[4][4].x = 3.0;  controlPointsArray[4][4].y = 0.0;  controlPointsArray[4][4].z = -1;
    //controlPointsArray[4][5].x = 3.0;  controlPointsArray[4][5].y = 1.8;  controlPointsArray[4][5].z = -1.0;
     
    //CIRCLE */
    
    controlPointsArray[0][0].x = -0.5;  controlPointsArray[0][0].y = 0.0;  controlPointsArray[0][0].z = 4.5;
    controlPointsArray[0][1].x = -2;  controlPointsArray[0][1].y = 0.0;  controlPointsArray[0][1].z = 3.0;
    controlPointsArray[0][2].x = -2;  controlPointsArray[0][2].y = 0.0;  controlPointsArray[0][2].z = 2.0;
    controlPointsArray[0][3].x = -2;  controlPointsArray[0][3].y = 0.0;  controlPointsArray[0][3].z = 1.0;
    controlPointsArray[0][4].x = -0.5;  controlPointsArray[0][4].y = 0.0;  controlPointsArray[0][4].z = -0.5;
    
    
    
    controlPointsArray[1][0].x = 1;  controlPointsArray[1][0].y = 0.0;  controlPointsArray[1][0].z = 6.0;
    controlPointsArray[1][1].x = 1;  controlPointsArray[1][1].y = 0.0;  controlPointsArray[1][1].z = 3.0;
    controlPointsArray[1][2].x = 1;  controlPointsArray[1][2].y = 0.0;  controlPointsArray[1][2].z = 2.0;
    controlPointsArray[1][3].x = 1;  controlPointsArray[1][3].y = 0.0;  controlPointsArray[1][3].z = 1.0;
    controlPointsArray[1][4].x = 1;  controlPointsArray[1][4].y = 0.0;  controlPointsArray[1][4].z = -2;
    //controlPointsArray[1][5].x = 0.0;  controlPointsArray[1][5].y = 1.8;  controlPointsArray[1][5].z = -1.0;
    
    
    controlPointsArray[2][0].x = 2.0;  controlPointsArray[2][0].y = -0.0;  controlPointsArray[2][0].z = 6.0;
    controlPointsArray[2][1].x = 2.0;  controlPointsArray[2][1].y = -0.0;  controlPointsArray[2][1].z = 3.0;
    controlPointsArray[2][2].x = 2.0;  controlPointsArray[2][2].y = 0.0;  controlPointsArray[2][2].z = 2.0;
    controlPointsArray[2][3].x = 2.0;  controlPointsArray[2][3].y = 0.0;  controlPointsArray[2][3].z = 1.0;
    controlPointsArray[2][4].x = 2.0;  controlPointsArray[2][4].y = 0.0;  controlPointsArray[2][4].z = -2.0;
    // controlPointsArray[2][5].x = 1.0;  controlPointsArray[2][5].y = 1.8;  controlPointsArray[2][5].z = -1.0;
    
    
    controlPointsArray[3][0].x = 3;  controlPointsArray[3][0].y = -0.0;  controlPointsArray[3][0].z = 6.0;
    controlPointsArray[3][1].x = 3;  controlPointsArray[3][1].y = -0.0;  controlPointsArray[3][1].z = 3.0;
    controlPointsArray[3][2].x = 3;  controlPointsArray[3][2].y = 0.0;  controlPointsArray[3][2].z = 2.0;
    controlPointsArray[3][3].x = 3;  controlPointsArray[3][3].y = 0.0;  controlPointsArray[3][3].z = 1.0;
    controlPointsArray[3][4].x = 3;  controlPointsArray[3][4].y = 0.0;  controlPointsArray[3][4].z = -2;
    // controlPointsArray[3][5].x = 2.0;  controlPointsArray[3][5].y = 1.8;  controlPointsArray[3][5].z = -1.0;
    
    
    controlPointsArray[4][0].x = 4.5;  controlPointsArray[4][0].y = -0.0;  controlPointsArray[4][0].z = 4.5;
    controlPointsArray[4][1].x = 6.0;  controlPointsArray[4][1].y = -0.0;  controlPointsArray[4][1].z = 3.0;
    controlPointsArray[4][2].x = 6.0;  controlPointsArray[4][2].y = 0.0;  controlPointsArray[4][2].z = 2.0;
    controlPointsArray[4][3].x = 6.0;  controlPointsArray[4][3].y = 0.0;  controlPointsArray[4][3].z = 1.0;
    controlPointsArray[4][4].x = 4.5;  controlPointsArray[4][4].y = 0.0;  controlPointsArray[4][4].z = -0.5;
    //controlPointsArray[4][5].x = 3.0;  controlPointsArray[4][5].y = 1.8;  controlPointsArray[4][5].z = -1.0;
    /*
     controlPointsArray[0][0].x = 0.0;   controlPointsArray[0][0].y = 0.0;  controlPointsArray[0][0].z = 0.0;
     controlPointsArray[0][1].x = 0.0;   controlPointsArray[0][1].y = 0.0;  controlPointsArray[0][1].z = 1.0;
     controlPointsArray[0][2].x = 0.0;   controlPointsArray[0][2].y = 0.0;  controlPointsArray[0][2].z = 2.0;
     controlPointsArray[0][3].x = 0.0;   controlPointsArray[0][3].y = 0.0;  controlPointsArray[0][3].z = 3.0;
     controlPointsArray[0][4].x = 0.0;   controlPointsArray[0][4].y = 0.0;  controlPointsArray[0][4].z = 4.0;
    // controlPointsArray[0][5].x = 0.0;   controlPointsArray[0][5].y = 0.0;  controlPointsArray[0][5].z = 5.0;
     
     
     controlPointsArray[1][0].x = 1;  controlPointsArray[1][0].y = 0.0;  controlPointsArray[1][0].z = 0.0;
     controlPointsArray[1][1].x = 1;  controlPointsArray[1][1].y = 0.0;  controlPointsArray[1][1].z = 1.0;
     controlPointsArray[1][2].x = 1;  controlPointsArray[1][2].y = 0.0;  controlPointsArray[1][2].z = 2.0;
     controlPointsArray[1][3].x = 1;  controlPointsArray[1][3].y = 0.0;  controlPointsArray[1][3].z = 3.0;
     controlPointsArray[1][4].x = 1;  controlPointsArray[1][4].y = 0.0;  controlPointsArray[1][4].z = 4.0;
//controlPointsArray[1][5].x = 1;  controlPointsArray[1][5].y = 0.0;  controlPointsArray[1][5].z = 5.0;
     
     
     controlPointsArray[2][0].x = 2;  controlPointsArray[2][0].y = 0;  controlPointsArray[2][0].z = 0;
     controlPointsArray[2][1].x = 2;  controlPointsArray[2][1].y = 0;  controlPointsArray[2][1].z = 1;
     controlPointsArray[2][2].x = 2;  controlPointsArray[2][2].y = 0;  controlPointsArray[2][2].z = 2.0;
     controlPointsArray[2][3].x = 2;  controlPointsArray[2][3].y = 0;  controlPointsArray[2][3].z = 3;
     controlPointsArray[2][4].x = 2;  controlPointsArray[2][4].y = 0;  controlPointsArray[2][4].z = 4;
    // controlPointsArray[2][5].x = 2;  controlPointsArray[2][5].y = 0;  controlPointsArray[2][5].z = 5;
     
     
     controlPointsArray[3][0].x = 3;  controlPointsArray[3][0].y = 0;  controlPointsArray[3][0].z = 0;
     controlPointsArray[3][1].x = 3;  controlPointsArray[3][1].y = 0;  controlPointsArray[3][1].z = 1;
     controlPointsArray[3][2].x = 3;  controlPointsArray[3][2].y = 0;  controlPointsArray[3][2].z = 2;
     controlPointsArray[3][3].x = 3;  controlPointsArray[3][3].y = 0;  controlPointsArray[3][3].z = 3;
     controlPointsArray[3][4].x = 3;  controlPointsArray[3][4].y = 0;  controlPointsArray[3][4].z = 4;
     //controlPointsArray[3][5].x = 3;  controlPointsArray[3][5].y = 0;  controlPointsArray[3][5].z = 5;
     
     
     controlPointsArray[4][0].x = 4;  controlPointsArray[4][0].y = 0;  controlPointsArray[4][0].z = 0;
     controlPointsArray[4][1].x = 4;  controlPointsArray[4][1].y = 0;  controlPointsArray[4][1].z = 1;
     controlPointsArray[4][2].x = 4;  controlPointsArray[4][2].y = 0;  controlPointsArray[4][2].z = 2;
     controlPointsArray[4][3].x = 4;  controlPointsArray[4][3].y = 0;  controlPointsArray[4][3].z = 3;
     controlPointsArray[4][4].x = 4;  controlPointsArray[4][4].y = 0;  controlPointsArray[4][4].z = 4;
    // controlPointsArray[4][5].x = 4;  controlPointsArray[4][5].y = 0;  controlPointsArray[4][5].z = 5;
    */
